...
@rsyms = \[ | \] | \| | \( | \) | \^ | \- | \[ \: "alpha" \: \] | \[ \: \^ "alpha" \: \] | \& \& | \- \- | \~ \~ | \\ | \. | \\ "d" | \\ "D" | \\ "pN" | \\ "PN" | \\ "p" | \{ | \} | \\ "P" | \* | \+ | \? | \* \? | \+ \? | \? \? | \, | \$ | \"
  ...
  b "[" 18
    (b "+?" 9
       ...
       (b "?" 14
          ...
          (b "A" 16 (b "??" 15 N N) (b "B" 17 N N))))
    (b "\\pN" 27
       (b "\\P" 23
          (b "\\" 21
             (b "[:alpha:]" 20 (b "[:^alpha:]" 19 N N) N) (b "\\D" 22 N N))
          (b "\\d" 25 (b "\\PN" 24 N N) (b "\\p" 26 N N)))
       (b "{" 32
          (b "b" 30 (b "^" 29 (b "]" 28 N N) N) (b "z" 31 N N))
